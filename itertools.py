# itertools are products and permutations that accumulate infinite itrators
# they consis product,permuation,combination,accumulate,group by and iterators
